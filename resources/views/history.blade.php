        ...
        <div>
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active">
                    <a href="#individualFoods" aria-controls="individualFoods" role="tab" data-toggle="tab"
                       style="color:black">
                        Individual Foods</a></li>
                <li role="presentation">
                    <a href="#dailyNutrients" aria-controls="dailyNutrients" role="tab" data-toggle="tab"
                       style="color:black">
            ...
            <div role="tabpanel" class="tab-pane" id="dailyNutrients">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>{{$vals->getRecommendedCalories()}} kcal</td>
                    </tr>
                    <tr>
                        @foreach($nutrients as $nutrient)
                            ...
                            <td>{{$vals->getRecommendedByID($nutrient->id)}} {{$nutrient->getUnits()}}</td>
                    </tr>
                    @endforeach
                </table>
            </div> <!--ends tabpanel-->
